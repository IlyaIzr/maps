export const enLocale = {
  ...
  newFeaturePHolder: "Place address or name",
  drawMode: "Draw mode",
  ...
  rateZeroModal: "Sure you want to rate it with 0?",
  toMain: "To main",
  menu: "Menu",
  ...
  "b&w": "Black&White",
  blueprint: "Blueprint",
  successfullReg: "Successfully registered!",
  ...
  occupied: "occupied",
  bannedPassword: "this password is unacceptable",
  error: "error",
  warning: "warning",
  complete: "complete",
  initConnectionErr:
    "Connection error, authorization failed. Please report it! err code: #auth12",
  ...
  // TODO
  loginToUseThis:
    "Log in to see your friends marks and their routes in the future",
  ...
  watchModeSub3:
    "Draw missing places. In this mode regular building-clicks might not work",
  default: "default",
  reset: "reset",
  asAnonimus: "as anonimus",
  send: "Send",
  ...
  watchAtMap: "enable exclusively on the map",
  ...
  thanksTo: "thanks to",
  drawModeLevelOnly:
    "Users with level 2 or higher can draw missing buildings on map. You get level 2 after posting 10 reviews",
  yes: "yes",
  no: "no",
  noName: "no name",
